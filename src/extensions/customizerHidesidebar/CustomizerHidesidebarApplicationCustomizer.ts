...
import * as strings from 'CustomizerHidesidebarApplicationCustomizerStrings';

const LOG_SOURCE: string = 'CustomizerHidesidebarApplicationCustomizer';
 ...
 */
export interface ICustomizerHidesidebarApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class CustomizerHidesidebarApplicationCustomizer
  extends BaseApplicationCustomizer<ICustomizerHidesidebarApplicationCustomizerProperties> {
